...
const CurrentRoundPrizes: React.FC<{prizes: Prize[], prizeCategory?: string}> = ({ prizes, prizeCategory }) => (
    <div className="mt-4 text-center">
        <h4 className="text-base sm:text-base [&[data-screen-profile=small]]:text-base font-bold text-brand-gold/80 font-display tracking-widest">INGRÉDIENTS À GAGNER</h4>
        {prizeCategory && (
